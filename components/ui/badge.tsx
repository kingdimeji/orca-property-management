  ...
  "inline-flex items-center rounded-full px-3 py-1 text-xs font-medium transition-colors border",
  {
    variants: {
      variant: {
        ...
        repairs: "bg-orange-100 text-orange-800 border-orange-300",
        utilities: "bg-yellow-100 text-yellow-800 border-yellow-300",
        insurance: "bg-blue-100 text-blue-800 border-blue-300",
        taxes: "bg-indigo-100 text-indigo-800 border-indigo-300",
        management_fees: "bg-purple-100 text-purple-800 border-purple-300",
